...
public class JoinSideInput extends KeyedProcessFunction<Long, NexmarkEvent, Tuple2<NexmarkEvent, String>> {
    ...
    public void open(OpenContext parameters) throws Exception {
        ...
        fillStaticTable(keyGroupRange, maxParallelism, keyAccessibleState, operatorIndex);
    }
    ...
    protected static void fillStaticTable(KeyGroupRange keyGroupRange, int maxParallelism,
                                        KeyAccessibleState<Long, List<String>> state, int opIndex){
        ...
        int numAuctions = 48*500_000; //30_000_000; // for 250 gb //48*500_000; for ~200gb
