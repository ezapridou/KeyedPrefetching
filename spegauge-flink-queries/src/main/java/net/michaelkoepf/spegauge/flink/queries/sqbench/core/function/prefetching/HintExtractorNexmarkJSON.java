...
public abstract class HintExtractorNexmarkJSON<K, T> extends ProcessFunction<NexmarkJSONEvent, T>{
    ...
    protected long hotIdsRatio = (150_000 * 3) / 49; // (scenario.numEventsPerSecond * AUCTION_PROPORTION) / PROPORTION_DENOMINATOR;

    public abstract boolean isHot(K key);

    public HintExtractorNexmarkJSON(String fieldName, boolean hintsForAuction) {
